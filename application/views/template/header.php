...
<html lang="en">
   <head>
      ...
      <meta name="description" content="Sistem Pengajuan Cuti Karyawan PT. Intan Berkat Terang" />
      <meta name="author" content="Harkovnet" />
      <title>PT. Intan Berkat Terang</title>
   ...
   <body class="sb-nav-fixed">
      <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
         <!-- Navbar Brand-->
         <a class="navbar-brand ps-3" href="<?php echo site_url('home'); ?>">PT. Intan Berkat Terang</a>
         <!-- Sidebar Toggle-->
    ...
    if ($pegawai && $pegawai['jabatan'] == 1) {
        ...
        <div class="collapse" id="collapsePegawai" aria-labelledby="headingPegawai" data-bs-parent="#sidenavAccordion">
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="<?php echo site_url('divisi'); ?>">Divisi</a>
                <a class="nav-link" href="<?php echo site_url('pegawai'); ?>">Pegawai</a>
            </nav>
        </div>
        <a class="nav-link" href="<?php echo site_url('cuti/permintaanadminindex'); ?>">
...
<?php
    ...
    <a class="nav-link" href="<?php echo site_url('pegawai/indexstaff'); ?>">
        <div class="sb-nav-link-icon"><i class="fas fa-users"></i></div>
        Data Staff
    </a>
    <a class="nav-link" href="<?php echo site_url('cuti/permintaanindex'); ?>">
        <div class="sb-nav-link-icon"><i class="fas fa-gear"></i></div>
        Permintaan Cuti
    </a>
    <a class="nav-link" href="<?php echo site_url('cuti/pengajuanmanagerindex'); ?>">
    ...
    <a class="nav-link" href="<?php echo site_url('cuti/pengajuanstaffindex'); ?>">
        <div class="sb-nav-link-icon"><i class="fas fa-file-alt"></i></div>
        Pengajuan Cuti
    </a>
    <?php
